...
// import { osVersion, osName, fullBrowserVersion, browserName, engineName, getUA, deviceType} from 'react-device-detect';
            ...
            <div className =   "aboutBackground" id = "aboutBackground">
              <div className = "aboutText" id = "aboutText">
                ...
                <div className = "aboutTextContent">
                  ...
                  {/*<br/>
                  <div className = "aboutTextContentBottom">
                    This application<br/>
                    <IoIosArrowForward className = "aboutArrowIcon" /> Research and make comparisions in multiple e-commerce websites based on category.<br/>
                    <IoIosArrowForward className = "aboutArrowIcon" /> Applies user filters and preferences.<br/>
                    <IoIosArrowForward className = "aboutArrowIcon" /> Ranks the products.<br/>
                    <IoIosArrowForward className = "aboutArrowIcon" /> Display them.
                  </div>*/}
                </div>
